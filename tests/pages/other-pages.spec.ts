...
test.describe('진행자 근무 관리', () => {
  test('should display schedule page @smoke', async ({ page }) => {
    ...
    await expect(page.locator('text=진행자 일정 관리')).toBeVisible();
    await expect(page.locator('text=고정 시간표')).toBeVisible();
  });
});
...
test.describe('모니터 대시보드', () => {
  test('should display monitor dashboard @smoke', async ({ page }) => {
    ...
    await expect(page.locator('text=모니터 대시보드')).toBeVisible();
    await expect(page.locator('text=실시간 세션')).toBeVisible();
    await expect(page.locator('text=테스트 세션')).toBeVisible();
  });
...
test.describe('활동 목록', () => {
  test('should display activity page @smoke', async ({ page }) => {
    ...
    await expect(page.locator('text=활동 목록')).toBeVisible();
...
test.describe('메시지', () => {
  ...
  test('should display alert rules section', async ({ page }) => {
    await page.goto(ROUTES.message);
    await expect(page.locator('text=진행자 알림 메시지')).toBeVisible();
  });
});
...
test.describe('리소스', () => {
  test('should display resource page @smoke', async ({ page }) => {
    ...
    await expect(page.locator('text=리소스 업로드')).toBeVisible();
    await expect(page.locator('text=리소스 목록')).toBeVisible();
  });
...
test.describe('아바타 관리', () => {
  test('should display avatar page @smoke', async ({ page }) => {
    ...
    await expect(page.locator('text=아바타 관리')).toBeVisible();
...
test.describe('회기 템플릿', () => {
  test('should display lesson template page @smoke', async ({ page }) => {
    ...
    await expect(page.locator('text=회기 템플릿 관리')).toBeVisible();
...
test.describe('커리큘럼', () => {
  test('should display curriculum page @smoke', async ({ page }) => {
    ...
    await expect(page.locator('text=커리큘럼 관리')).toBeVisible();
...
test.describe('프롬프트 변수', () => {
  test('should display prompt variable page @smoke', async ({ page }) => {
    ...
    await expect(page.locator('text=프롬프트 변수 관리')).toBeVisible();
...
test.describe('로그', () => {
  test('should display log page @smoke', async ({ page }) => {
    ...
    await expect(page.locator('text=핑퐁이 세션 로그')).toBeVisible();
...
test.describe('권한 관리', () => {
  test('should display member page @smoke', async ({ page }) => {
    ...
    await expect(page.locator('text=권한 관리')).toBeVisible();
